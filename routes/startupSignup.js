...
router.post('/',function (req,res){
    ...
    let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: "AdministratorEmail@gmail.com", // generated ethereal user
            pass: "AdministratorPassword" // generated ethereal password
        }
    });

// setup email data with unicode symbols
    let mailOptions = {
        from: 'AdministratorEmail@gmail.com', // sender address
